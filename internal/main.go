...
import (
	...
	"github.com/coreos/coreos-metadata/internal/providers/cloudstackMetadata"
...
func main() {
	...
	case "azure", "digitalocean", "ec2", "gce", "packet", "openstack-metadata", "cloudstack":
	default:
...
func fetchMetadata(provider string) (providers.Metadata, error) {
	...
	case "cloudstack":
		return cloudstackMetadata.FetchMetadata()
	default:
		panic("bad provider")
	}
}
