...
* kubevirt
  ...
  - AFTERBURN_KUBEVIRT_IPV4
  - AFTERBURN_KUBEVIRT_IPV6
* openstack
...
* openstack-metadata
  ...
  - AFTERBURN_OPENSTACK_INSTANCE_TYPE
* outscale
  - AFTERBURN_OUTSCALE_AMI_ID
  - AFTERBURN_OUTSCALE_AVAILABILITY_ZONE
  - AFTERBURN_OUTSCALE_HOSTNAME
  - AFTERBURN_OUTSCALE_INSTANCE_ID
  - AFTERBURN_OUTSCALE_INSTANCE_TYPE
  - AFTERBURN_OUTSCALE_LOCAL_IPV4
  - AFTERBURN_OUTSCALE_RESERVATION_ID
* oraclecloud
