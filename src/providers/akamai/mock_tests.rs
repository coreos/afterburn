...
fn test_attributes() {
    ...
    let expected = HashMap::from([
        ...
        (
            ...
            "a631b16d14534d84e2830da16d1b28e1d08d24df".to_string(),
        ),
        ("AKAMAI_INSTANCE_LABEL".to_string(), "my-linode".to_string()),
        ("AKAMAI_INSTANCE_REGION".to_string(), "us-ord".to_string()),
        (
            "AKAMAI_INSTANCE_TYPE".to_string(),
            "g6-nanode-1".to_string(),
        ),
        (
            "AKAMAI_INSTANCE_TAGS".to_string(),
            "foo:bar:baz".to_string(),
        ),
        ("AKAMAI_PUBLIC_IPV4_0".to_string(), "1.2.3.4/32".to_string()),
        (
            "AKAMAI_PRIVATE_IPV4_0".to_string(),
            "192.168.1.1/32".to_string(),
        ),
        (
            "AKAMAI_IPV6_SLAAC".to_string(),
            "2600:3c06::f03c:94ff:fecb:c10b/128".to_string(),
        ),
        (
            "AKAMAI_IPV6_LINK_LOCAL".to_string(),
            "fe80::f03c:94ff:fecb:c10b/128".to_string(),
        ),
    ]);
